...
class AnalizadorHiloDiscusion:
    ...
    def detectar_subtemas(self, n_clusters=3):
        ...
        vec = TfidfVectorizer(max_features=500, stop_words=self.idioma)
    ...
    def resumen_hilo(self):
        ...
        if not self.mensajes:
            return {'error': 'No hay mensajes en el hilo'}
...
if __name__ == '__main__':
    ...
    # Hilo 1: Discusion sobre IA en ingles
    hilo_ia = [
    ...
    # Hilo 2: Debate tecnologico en espanol
    hilo_tech_es = [
        {"usuario": "@carlos_dev", "texto": "La nueva version de Python 3.13 trajo mejoras increibles en rendimiento #python",
         "timestamp": "11:00"},
        {"usuario": "@maria_codes", "texto": "Totalmente de acuerdo, el nuevo JIT compiler es impresionante #python #rendimiento",
         "timestamp": "11:05"},
        {"usuario": "@jose_ti", "texto": "Pero la compatibilidad hacia atras siempre es un problema en produccion #legacy",
         "timestamp": "11:08"},
        {"usuario": "@carlos_dev", "texto": "Si, pero por eso existen los entornos virtuales y contenedores #docker",
         "timestamp": "11:12"},
        {"usuario": "@laura_ds", "texto": "Desde ciencia de datos, el rendimiento importa mucho para entrenar modelos #datascience",
         "timestamp": "11:15"},
        {"usuario": "@maria_codes", "texto": "Exacto, con pandas y numpy las mejoras se notan muchisimo #data",
         "timestamp": "11:20"},
        {"usuario": "@jose_ti", "texto": "Todavia prefiero Rust para sistemas en produccion, Python para prototipado #rustlang",
         "timestamp": "11:25"},
        {"usuario": "@laura_ds", "texto": "Cada lenguaje tiene su niche. Python gana en ML y数据分析 #machinelearning",
         "timestamp": "11:30"},
        {"usuario": "@carlos_dev", "texto": "Exacto, usemos la herramienta correcta para cada trabajo #devtools",
         "timestamp": "11:35"},
        {"usuario": "@maria_codes", "texto": "Gran debate! Al final lo importante es escribir codigo limpio y mantenible #cleancode",
         "timestamp": "11:40"},
    ]

    analizador = AnalizadorHiloDiscusion()

    for nombre_hilo, hilo in [("Hilo IA (ingles)", hilo_ia), ("Hilo Python (espanol)", hilo_tech_es)]:
        analizador.cargar_hilo(hilo)
